...
func init() {
	...
	utilruntime.Must(wireguardkloudlitegithubcomv1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&kubeSvcAddr, "kube-svc-addr", "", "--kube-svc-addr [host]:<port>")
	opts := zap.Options{
		Development: true,
	}
	...
	cfg := func() *rest.Config {
		if kubeSvcAddr != "" {
			return &rest.Config{Host: kubeSvcAddr}
		}
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:       "8cc84f1a.wireguard.kloudlite.github.com",
